...
import { PenNib, Image, CaretDown, PaperPlaneRight, ArrowLeft } from '@phosphor-icons/react';
        ...
        <div className="text-gray-800 antialiased min-h-screen flex flex-col bg-slate-50/50">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6">
                    <div className="flex justify-between h-16 items-center">
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="font-extrabold text-sm tracking-tight text-slate-900 font-display">New Article Draft</span>
                        </div>
            ...
            <main className="flex-grow py-12 px-4 sm:px-6 max-w-3xl mx-auto w-full animate-fade-in">
                <div className="bg-white rounded-3xl border border-slate-100 p-6 sm:p-10 shadow-sm">
                    <form id="createBlogForm" onSubmit={handleSubmit} className="space-y-8 text-left">
                        ...
                        <div className="space-y-2 pt-4 border-t border-slate-100">
                            ...
                            <textarea
                                ...
                                placeholder="Tell your story. Write your concepts, snippets, guidelines, or ideas here..."
                            />
                        </div>
